---
title: "How to Automate HMRC Reporting for Property Income"
date: 2026-04-07
draft: false
description: "Learn how to automate HMRC reporting for property income. Covers data import, expense tracking, and generating compliant reports in minutes."
...
slug: "how-to-automate-hmrc-reporting-property-income"
---
...
- **10 properties** = hundreds of transactions per month
- **Multiple currencies** = conversion headaches
...
- Downloading CSVs from each platform: 15–30 minutes
- Cleaning and formatting data: 30–60 minutes
- Matching properties across platforms: 15–30 minutes
...
- Imports data from your platforms (Airbnb, Booking.com, VRBO, etc.)
- Tracks income at property level
- Handles expenses
- Generates HMRC-ready output

[HMRC Reporter](https://hmrcreporter.com/) does all of this. It's built specifically for short-term rental income and supports 27+ platforms.

### Step 2: Set Up Your Properties

Add each property to the system. Link your platform listings so the software can match bookings to the right property.

### Step 3: Import Your Data

Upload CSV exports from your platforms. A good tool will:

- Recognise the format automatically
- Extract gross income, fees, and booking details
- Handle currency conversion if needed
- Flag any issues (missing data, duplicates)

### Step 4: Review and Adjust

Automation handles 90% of the work. You still need to:

- Add expenses that platforms don't report (maintenance, insurance, etc.)
- Check for unusual entries
- Confirm personal use days

### Step 5: Generate and Submit

Once everything looks right, generate your report. You'll get either:

- Completed Self Assessment figures (SA105 property pages)
- HMRC Digital Platform Reporting XML (for upload to HMRC)
...
- Property income over £50,000: MTD mandatory from April 2026
...
|---|---|---|
| Data import | 15–30 min | 2 min |
| Property matching | 15–30 min | Automatic |
| Gross income calc | 15–30 min | Automatic |
| Expense tracking | 30–60 min | 10–15 min |
| Report generation | 30–60 min | 1 min |
| **Total per month** | **2–4 hours** | **15–30 min** |
| **Error risk** | High | Low |
