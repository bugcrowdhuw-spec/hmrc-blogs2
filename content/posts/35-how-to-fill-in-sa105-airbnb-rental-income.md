---
title: "How to Fill in SA105 for Airbnb and Rental Income"
date: 2026-04-01
description: "Learn how to fill in the SA105 form for Airbnb and rental income. Step-by-step guide to HMRC property pages for UK landlords and hosts."
---

If you earn money from Airbnb or other rental properties, you'll need to complete the SA105 form as part of your Self Assessment tax return. For many property managers, the SA105 — also known as the "UK Property" supplementary pages — is the most confusing part of the whole process.
...
The SA105 is a supplementary page to the main SA100 Self Assessment tax return. Anyone who receives income from UK property — including short-term lets like Airbnb — must complete it if their total rental income exceeds £1,000 (after the property income allowance).
...
- Receive rent from a room above the £7,500 rent-a-room threshold
...
- Your combined property income (including Airbnb) exceeds £1,000 before expenses
- You're not using the £1,000 property income allowance to fully cover your income
- You're running a furnished holiday let
- You want to claim allowable expenses against your rental income

Even if you only listed your property on Airbnb for a few weeks, you still need to report it. HMRC now receives data directly from platforms like Airbnb through the OECD digital platform reporting rules. This means HMRC already knows about your income — they're matching it against Self Assessment records.

### Do You Report Gross or Net Airbnb Income?

You report the **gross income** — the total amount paid by guests before Airbnb deducts its service fees. The fees Airbnb charges you are then listed as an allowable expense. This catches many first-time hosts off guard.

For example, if a guest pays £500 for a booking and Airbnb takes £60 in service fees, you report £500 as income and £60 as an expense. You do not report just the £440 you receive.
...
- **Total rents and other income from UK property** — the full amount guests paid (before any deductions)
- **Total expenses** — the sum of all allowable expenses (covered below)
...
Don't include the Airbnb host service fee in your income — that's an expense. Also don't include security deposits that you return to guests, unless you've kept part or all of the deposit.

**For Airbnb hosts:** Download your annual earnings summary from your Airbnb dashboard. Go to **Account → Earnings → Annual Summary**. This report breaks down your gross earnings and is the easiest way to get accurate figures.
...
- **Airbnb and platform service fees** — the percentage Airbnb deducts from each booking
- **Cleaning and laundry** — professional cleaning between guests, linen hire
- **Insurance** — landlord insurance, public liability, contents insurance
- **Utilities** — gas, electricity, water, Wi-Fi, council tax (where you pay it)
- **Repairs and maintenance** — fixing a leak, repainting, replacing a broken appliance
- **Property management fees** — if you use a management company or co-host
- **Advertising and marketing** — listing fees, professional photography
- **Accounting fees** — if you use an accountant to prepare your return
- **Mortgage interest** — you can claim 20% tax credit on mortgage interest (see below)
- **Ground rent and service charges** — for leasehold properties
- **Stationery, phone, and broadband** — the business-use portion
...
1. You report your full rental income (not reduced by mortgage interest)
2. You claim all other allowable expenses
3. The mortgage interest tax credit is applied separately, reducing your final tax bill by 20% of the interest
...
You claim the cost of the **replacement** — not the original purchase. If you replace a £200 mattress with a £250 mattress, you can claim £200. If you buy a cheaper replacement, you claim the lower amount.
...
- **Private use adjustment** — if you use the property personally for part of the year, you must reduce your expenses proportionally
- **Balancing charges** — if you previously claimed capital allowances and sold an item for more than its written-down value
- **Losses brought forward** — if you made a loss in a previous tax year, you can offset it against this year's profit
...
1. **Reporting net income instead of gross** — always report the full booking amount before platform fees
2. **Claiming mortgage interest as an expense** — it's a separate tax credit, not an allowable expense
3. **Forgetting cleaning fees received from guests** — these count as income
4. **Missing the private use adjustment** — claiming 100% of expenses when you use the property yourself
5. **No records to back up claims** — HMRC can disallow expenses without receipts
6. **Not reporting Airbnb income at all** — platform reporting means HMRC already knows
...
If you manage one property, completing the SA105 is manageable. But most property managers don't stop at one. As your portfolio grows — even just to three or four Airbnb listings — the record-keeping becomes a part-time job.
...
### Do I need to fill in the SA105 if I earned less than £1,000 from Airbnb?

No. If your total property income is £1,000 or less, you can use the £1,000 property income allowance and won't need to complete the SA105. However, you should still register for Self Assessment and declare the income on your main SA100 form if it's your only untaxed income.
...
- [HMRC Property Income Allowance: What It Means for Airbnb Hosts](/blog/34-hmrc-property-income-allowance-airbnb-hosts)
- [Can You Claim the Rent-a-Room Scheme on Airbnb?](/blog/36-can-you-claim-rent-a-room-scheme-airbnb)
- [How to Report Multiple Airbnb Properties to HMRC](/blog/40-report-multiple-airbnb-properties-hmrc)
