...
**If you rent out a property on Airbnb, HMRC already knows about it. Here's how their systems work — and what that means for you.**
...
Your bank is required to report unusual patterns to HMRC. If you're receiving regular payments from Airbnb — even split across multiple bookings — your bank notices.
...
This information goes directly to HMRC's systems — no audit required.
...
1. **Letter or online prompt** — HMRC asks you to review your tax position
2. **Compliance check** — They request your records
3. **Penalty assessment** — If there's a discrepancy, penalties range from 0-30% of the missing tax
4. **Criminal investigation** — Only for deliberate fraud
...
- **Report all income** on your Self Assessment, even if it's under £1,000
...
### Does HMRC know about my Airbnb income even if I earn less than £1,000?

Yes. The £1,000 Property Income Allowance is optional. If you claim it, you still need to tell HMRC. If you don't claim it and report properly, HMRC still receives data from platforms.
