...
*Note: This is an updated overview. For the complete guide, see our [detailed walkthrough](/blog-posts/01-how-to-report-airbnb-income-to-hmrc).*
...
[HMRC Reporter](https://hmrcreporter.com/) imports your Airbnb data and generates HMRC-ready reports automatically. Works with Airbnb, Booking.com, VRBO, and 24+ other platforms.

[Read the full guide →](/blog-posts/01-how-to-report-airbnb-income-to-hmrc)
[Get started with HMRC Reporter →](https://hmrcreporter.com/)

---

**Tags:** Airbnb income HMRC, report Airbnb income UK, Airbnb tax self assessment, property income tax

**Meta description:** How to report Airbnb income to HMRC in the UK. Covers gross vs net income, Self Assessment, the £1,000 allowance, and platform reporting rules.
