---
title: "How to Calculate Airbnb Profit for HMRC"
date: 2026-04-03
description: "How to calculate Airbnb profit for HMRC — income minus allowable expenses."
---
...
- **Airbnb earnings** — From platform statements
- **Booking.com, Vrbo** — Other platforms
- **Direct bookings** — Cash, bank transfer
- **Cleaning fees kept** — If you keep them
- **Any other rental income** — Related to property

**Important:** Gross income before platform fees.

### Where to Find Numbers

- Airbnb: Dashboard → Earnings →Export
...
Only for standard lettings. Airbnb is usually considered Furnished Holiday Let — rules differ.
