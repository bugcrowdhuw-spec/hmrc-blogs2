...
**Unprompted:** You told HMRC about the error before they found it.
**Prompted:** You only corrected the error after HMRC raised it.
...
[HMRC Reporter](https://hmrcreporter.com/) automates income calculation and report generation, reducing the risk of manual errors.
...
**Meta description:** What happens if you report incorrect income to HMRC? Covers penalties, investigation triggers, types of errors, and how to avoid costly mistakes.
