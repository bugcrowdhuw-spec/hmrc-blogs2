...
- **MTD replaces Self Assessment** for property income (phased rollout from April 2026)
- **Digital records are mandatory** — paper and basic spreadsheets won't cut it
...
If you own rental properties and your gross property income exceeds the threshold, MTD applies to you directly.
...
**Before:** Monthly or annual spreadsheet updates, paper receipts.

**After:** Continuous digital recording. Every transaction — income and expense — must be recorded digitally with dates and categories.
...
**Before:** Optional. Many property managers used spreadsheets or paper.
...
- **Income:** Rent received, platform income (Airbnb, Booking.com), service charges received
- **Expenses:** Maintenance, repairs, insurance, mortgage interest, management fees, utilities
...
1. **Calculate your gross property income** — check which threshold applies
2. **Audit your current systems** — identify what needs to change
3. **Choose MTD software** — research options now, don't wait

### Before Your MTD Start Date

4. **Digitise all records** — move from paper/spreadsheet to software
5. **Set up properties** — add details for each property
6. **Organise expenses** — create consistent categories
7. **Practice quarterly reporting** — run a test quarter

### Ongoing

8. **Record transactions as they happen** — don't batch at quarter-end
9. **Review quarterly submissions** — check for accuracy before submitting
10. **Keep receipts digitally** — photos or scans of all expense receipts

## Software Options for Property Managers

| Software | Best for | Platform import | Multi-owner | MTD |
|---|---|---|---|---|
| [HMRC Reporter](https://hmrcreporter.com/) | STR property managers | ✅ 27+ | ✅ | ✅ |
| Xero | General accounting | ❌ | ⚠️ | ✅ |
| Landlord Vision | Long-term rentals | ❌ | ✅ | ✅ |
| FreeAgent | Small landlords | ❌ | ❌ | ✅ |

For property managers handling short-term rental income, [HMRC Reporter](https://hmrcreporter.com/) is the most direct fit — it imports platform data and supports MTD in one tool.
...
*Stay ahead of Making Tax Digital. [HMRC Reporter](https://hmrcreporter.com/) helps property managers keep digital records and submit quarterly updates. [Learn more →](https://hmrcreporter.com/)*
