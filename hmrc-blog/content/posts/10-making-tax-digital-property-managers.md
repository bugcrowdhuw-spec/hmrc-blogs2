---
title: "Making Tax Digital for Property Managers: What You Must Do"
date: 2026-04-11
draft: false
description: "Making Tax Digital for property managers explained. Covers MTD timeline, requirements, quarterly submissions, and how to prepare for 2026."
tags: ["Making Tax Digital property managers", "MTD Income Tax", "landlord MTD", "quarterly tax submissions", "HMRC digital records"]
image: "/images/diagram-mtd-timeline-new.svg"
slug: "making-tax-digital-property-managers"
---
...
Paper records and spreadsheets alone won't be sufficient. You need MTD-compatible software.
...
Calculate your total property income (before expenses). If it's over £50,000, MTD applies from April 2026.

### Step 2: Go Digital

If you're still using paper records or basic spreadsheets, switch to MTD-compatible software now. Don't wait until the deadline.
...
- Generate an End of Period Statement
- Handle property-level tracking

[HMRC Reporter](https://hmrcreporter.com/) supports MTD requirements for property income, including multi-platform import and digital record keeping.
...
MTD requires property-level detail. Make sure you have:

- Each property's address and details
- Income tracked per property
- Expenses categorised per property
- Ownership details (including splits)

## How MTD Affects Different Types of Property Managers

### Single Property Landlords

If you have one property with straightforward income, MTD is manageable. The main change is quarterly submissions instead of one annual return.

### Multi-Property Managers

The complexity increases with each property. You need to track income and expenses separately for every property and submit quarterly summaries.
...
*Get ready for Making Tax Digital. [HMRC Reporter](https://hmrcreporter.com/) keeps digital records and supports MTD compliance for property managers. [Learn more →](https://hmrcreporter.com/)*
